...
public class IngredienteComida {
    ...
    public String toString() {
        //return "IngredienteComida{" + "idIngredienteComida=" + idIngredienteComida + ", comida=" + comida.getIdComida() + ", ingrediente=" + ingrediente.getIdIngrediente() + '}';
        return "IngredienteComida{" + "idIngredienteComida=" + idIngredienteComida + ", comida=" + comida + ", ingrediente=" + ingrediente.getIdIngrediente() + '}';
    }
